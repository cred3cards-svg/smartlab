...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      teal: "bg-brand-teal-pale text-brand-teal border border-brand-teal/20 hover:bg-brand-teal hover:text-white focus-visible:ring-brand-teal active:scale-[0.98]",
      outline:
        "border-2 border-brand-blue text-brand-blue bg-transparent hover:bg-brand-blue hover:text-white focus-visible:ring-brand-blue active:scale-[0.98]",
      ghost:
        "text-text-secondary bg-transparent hover:bg-surface-soft hover:text-text-primary focus-visible:ring-brand-teal active:scale-[0.98]",
      danger:
        "bg-status-danger text-white hover:opacity-90 focus-visible:ring-status-danger active:scale-[0.98]",
    };
